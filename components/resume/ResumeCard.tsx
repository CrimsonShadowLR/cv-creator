    ...
    <div className="flex flex-col gap-3 bg-bg rounded-[var(--radius-lg)] border border-border-subtle p-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-[var(--radius-sm)] border border-border-default text-text-secondary text-[12px] font-medium font-body hover:bg-bg-surface transition-colors"
        >
          <Eye size={14} />
          Preview
        </Link>
        <Link
          href={`/templates?resume=${id}`}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-[var(--radius-sm)] border border-border-default text-text-secondary text-[12px] font-medium font-body hover:bg-bg-surface transition-colors"
        >
          <FileDown size={14} />
          Generate
